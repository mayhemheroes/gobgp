...
## Run Information
- Mayhem Run: mayhemheroes/gobgp/parse-bgp-message/7
- Git Commit: e2ae6daf0ba28a900041fe9b0329e8b1fc67fde9
- Original Image: ghcr.io/mayhemheroes/gobgp:v3.34.0
- CI URL: https://github.com:443/mayhemheroes/gobgp//actions/runs/15744415694
...
- `rlenv/source/gobgp/` - Source code (build from this location)
...
3. **Extract build steps**: Move build commands to `rlenv/mayhem/data/scripts/build.sh` that builds from `/rlenv/source/gobgp/`
...
- Source code should be at `/rlenv/source/gobgp/` in the container
- Build script should work from `/rlenv/source/gobgp/`
